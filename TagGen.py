...
class Tag:
    def __init__(self, tag, single=False, klass=None, **kwargs):
        self.tag = tag
        self.text = ""
        self.attributes = {}
        self.single = single
        self.children = []
#key word change block
        if klass is not None:
            self.attributes["class"] = " ".join(klass)
#underscore change block
        ...
        with TopLevelTag("body") as body:
            ...
            with Tag("div", klass=("container", "container-fluid"), id="lead") as div:
                with Tag("p") as paragraph:
                    ...
                    div += paragraph
                with Tag(
                    "img", single=True, src="/icon.png", data_image="responsive"
                ) as img:
                    div += img
